...
class SellerProfileCard extends React.Component {
          ...
          <Row>
            <Col xs={12}>
              ...
              */}
              ...
              {editable && <EditProductsModal products={products} role_id={id} headerEdit type="seller" />}
              <Divider style={{ marginLeft: -16, marginRight: -16 }} />
              {
            ...
            */}
            ...
            {
              <Col xs={12}>
                <h6 className={styles.cardSubHeader}>Additional Seller-Specific Details</h6>
                {
                  editable &&
                    <RoleItemEditModal
                      type={type}
              ...
              */}
                ...
                <Row>
                  ...
                  {/* ((services_provided && some(services_provided.details, 'value')) || editable) &&
                  <Col xs={12}>
                    <h6 className={styles.cardSubHeader}>Services We Offer</h6>
                    {editable && <ProfileListEditModal type="services" data={services_provided} title="Services You Offer" />}
                    <Divider style={{ marginLeft: -16, marginRight: -16 }} />
                    <Row>
                      <ul className="noMarginBottom">
                        {services_provided && some(services_provided.details, 'value') ?
                          map(filter(services_provided.details, 'value'), (item, key) =>
                            <li key={key}>{item.display}</li>
                          )
                          :
                            <li>
