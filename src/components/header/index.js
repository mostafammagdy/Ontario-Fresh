...
class Header extends React.Component {
  ...
  render() {
    ...
    /*
    console.log('%c loggedIn, profile.authed, profile.authed.is_manager:', 'color: orange; font-weight: bold;')
    console.log({ loggedIn, authed: profile.authed, is_manager: profile.authed.is_manager })
    */
    
    if (loggedIn && profile.authed && !profile.authed.is_manager) {
      return (
        <HeaderHub handleLogout={this.handleLogout} />
      )
    } else if (loggedIn && profile.authed && profile.authed.is_manager) {
      return (
        <HeaderHub
