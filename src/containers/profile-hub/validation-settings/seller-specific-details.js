 ...
 */
export const SELLER_SPECIFIC_DETAILS_FORM_INPUT_VALIDATION_SETTINGS = {
    "sellerBusinessSizeCheckboxes": [
        {
            "test": paramsObj => selectedCheckboxMaximum(paramsObj),
            "message": "You can only choose one business size.",
            "focus": "sellerBusinessSizeCheckboxes-legend"
        }
    ],
    "sellerThirdPartyInsuranceCheckboxes": [
        {
            "test": paramsObj => selectedCheckboxMaximum(paramsObj),
            "message": "You can only choose one insurance option.",
            "focus": "sellerThirdPartyInsuranceCheckboxes-legend"
        }
    ]
}