import { requiredCheckbox } from '../../../utils/form-input-validation-tests'
 ...
 */
export const BUSINESS_CATEGORIES_FORM_INPUT_VALIDATION_SETTINGS = {
    "businessCategoriesCheckboxes": [
        {
            "test": paramsObj => requiredCheckbox(paramsObj),
            "message": "You must choose at least one category.",
            "focus": "businessCategoriesCheckboxes-legend"
        }
    ]
}