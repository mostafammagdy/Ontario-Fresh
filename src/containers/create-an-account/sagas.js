...
function* signupFlow (action) {
  ...
  console.log({ action })
  try {
    console.log('%c NOTE: Might need to make some adjustments here depending on what happens once I can clear my submitted accounts from the database.', 'font-style: italic;')
